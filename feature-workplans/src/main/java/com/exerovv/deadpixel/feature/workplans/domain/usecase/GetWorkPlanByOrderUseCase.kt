...
class GetWorkPlanByOrderUseCase @Inject constructor(private val repo: WorkPlansRepository) {
    suspend operator fun invoke(orderId: Int): WorkPlan? = repo.getWorkPlanByOrder(orderId)
}
